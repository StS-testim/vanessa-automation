...
Сценарий: Проверка видимости полей с учетом родителя
	...
	И я жду, что элемент формы с именем 'ЭлементНевидимаяГруппа1' будет отсутствовать на форме в течение 10 секунд
	И элемент формы с именем "ЭлементНевидимаяГруппа1" существует и невидим на форме
	И я жду когда исчезнет элемент с именем "ЭлементНевидимаяГруппа1" в течение 20 секунд
