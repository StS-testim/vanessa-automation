...
* Обход проблемы https://github.com/lintest/VanessaExt/issues/88 Неверное определение группы парсером Gherkin #2321
...
* Не получилось нажать на кнопку <Find> при включенной эмуляции мыши #2311 Спасибо @StS-testim
