...
Функция ПолучитьИмяФайлаВидеоШага(ПараметрыВидео)
	Если ПараметрыВидео.ЭтоИнициализация Тогда
		Стр = "init.mp4";
	Иначе	
		Стр = "scen_" + ДобавитьНулей(ПараметрыВидео.ТекИД_СценарияВМассиве, 5) + "_step_" 
			+ ДобавитьНулей(ПараметрыВидео.ТекИД_ШагаВМассиве, 5) + "_main.mp4";
	КонецЕсли;	 
